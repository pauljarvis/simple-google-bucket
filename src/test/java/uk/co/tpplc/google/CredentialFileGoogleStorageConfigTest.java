...
import static uk.co.tpplc.google.CredentialFileGoogleStorageConfig.*;
...
public class CredentialFileGoogleStorageConfigTest {
    ...
    private final CredentialFileGoogleStorageConfigBuilder builder = new CredentialFileGoogleStorageConfigBuilder(credentialConverter);
